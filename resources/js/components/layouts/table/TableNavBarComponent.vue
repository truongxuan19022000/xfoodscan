        ...
        <div class="container flex flex-col lg:flex-row items-center justify-between">
            <div class="w-full flex items-center justify-between gap-3 xl:gap-8 lg:justify-start lg:w-fit">
                ...
                <div class="flex items-center gap-2 lg:hidden">
                    ...
                    <router-link v-if="lastOrder" :to="{ name: 'table.tableOrder.details', params: { slug: lastSlug || this.$route.params.slug, id: lastOrder } }"
                        class="flex items-center justify-center gap-1.5 w-fit rounded-3xl capitalize text-sm font-medium h-8 px-2.5 transition text-white bg-primary">
                        <i class="lab lab-reserve-line text-sm"></i>
                    </router-link>
            ...
            <div class="flex flex-col items-center justify-end gap-3 w-full mt-4 lg:flex-row lg:w-fit lg:mt-0">
                ...
                <router-link v-if="lastOrder" :to="{ name: 'table.tableOrder.details', params: { slug: lastSlug || this.$route.params.slug, id: lastOrder } }"
                    class="hidden lg:flex items-center justify-center gap-1.5 w-fit rounded-3xl capitalize text-sm font-medium h-8 px-3 transition text-white bg-primary">
                    <i class="lab lab-reserve-line text-sm"></i>
                    <span class="whitespace-nowrap">{{ $t('button.go_to_order') }}</span>
                </router-link>
...
export default {
    ...
    computed: {
        ...
        lastOrder: function () {
            return this.$store.getters['tableDiningOrder/lastOrder'];
        },
        lastSlug: function () {
            return this.$store.getters['tableDiningOrder/lastSlug'];
        }
    },
    mounted() {
