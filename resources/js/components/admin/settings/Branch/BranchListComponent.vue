    ...
    methods: {
        ...
        edit: function (branch) {
            ...
            this.props.form = {
                ...
                bank_acq_id: branch.bank_acq_id,
                bank_transfer_info: branch.bank_transfer_info,
                vietqr_client_id: branch.vietqr_client_id,
                vietqr_api_key: branch.vietqr_api_key,
                email: branch.email,
                phone: branch.phone,
