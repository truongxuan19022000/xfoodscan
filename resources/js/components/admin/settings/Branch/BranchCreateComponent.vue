<template>
    ...
    <div id="modal" class="modal">
        ...
        errors.state[0]
                        ...
                        <div class="form-col-12">
                            <h4 class="text-sm font-semibold text-heading mb-3 border-b border-[#D9DBE9] pb-2">{{ $t("label.payment_settings") }}</h4>
                        </div>

                        <div class="form-col-12 sm:form-col-6">
                            <label for="branch_code" class="db-field-title">{{ $t("label.branch_code") }}</label>
                            <input v-model="props.form.branch_code" type="text" id="branch_code" class="db-field-control" />
                        </div>

                        <div class="form-col-12 sm:form-col-6">
                            <label for="shop_name" class="db-field-title">{{ $t("label.shop_name") }}</label>
                            <input v-model="props.form.shop_name" type="text" id="shop_name" class="db-field-control" />
                        </div>

                        <div class="form-col-12 sm:form-col-6">
                            <label for="bank_account_no" class="db-field-title">{{ $t("label.bank_account_no") }}</label>
                            <input v-model="props.form.bank_account_no" type="text" id="bank_account_no" class="db-field-control" />
                        </div>

                        <div class="form-col-12 sm:form-col-6">
                            <label for="bank_acq_id" class="db-field-title">{{ $t("label.bank_acq_id") }}</label>
                            <input v-model="props.form.bank_acq_id" type="text" id="bank_acq_id" class="db-field-control" placeholder="VD: 970423" />
                        </div>

                        <div class="form-col-12">
                            <label for="bank_transfer_info" class="db-field-title">{{ $t("label.bank_transfer_info") }}</label>
                            <input v-model="props.form.bank_transfer_info" type="text" id="bank_transfer_info" class="db-field-control" />
                        </div>

                        <div class="form-col-12 sm:form-col-6">
                            <label for="vietqr_client_id" class="db-field-title">VietQR Client ID</label>
                            <input v-model="props.form.vietqr_client_id" type="text" id="vietqr_client_id" class="db-field-control" />
                        </div>

                        <div class="form-col-12 sm:form-col-6">
                            <label for="vietqr_api_key" class="db-field-title">VietQR API Key</label>
                            <input v-model="props.form.vietqr_api_key" type="text" id="vietqr_api_key" class="db-field-control" />
                        </div>
