        ...
        <div class="modal-dialog max-w-[340px] rounded-none" id="print" :dir="direction">
            <div class="modal-body">
                <div class="text-center pb-3.5 border-b border-dashed border-gray-400">
                    <h3 class="text-2xl font-bold mb-1">{{  branch.shop_name }}</h3>
                ...
                <!-- <div class="flex flex-col items-center">
                    ...
                    <h6 class="text-xs font-normal text-[11px] leading-[14px] capitalize text-heading">{{ branch.shop_name }}</h6>
                </div> -->
            </div>
        </div>
    </div>
...
export default {
    ...
    computed: {
        ...
        branch: function () {
            console.log("Branch data:", this.$store.getters["backendGlobalState/branchShow"]);
