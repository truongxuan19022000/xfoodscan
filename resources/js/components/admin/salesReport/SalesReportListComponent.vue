        ...
        <div class="db-card db-tab-div active">
            ...
            <div class="row px-5 mt-5 mb-5">
                ...
                <div class="col-12 sm:col-6 md:col-4 lg:col-6 xl:col-3">
                    <div class="border flex items-center gap-4 p-4 rounded-lg">
                        <div class="bg-[#F7F7F7] w-12 h-12 rounded-full flex items-center justify-center">
                            <i class="lab-sale-summary text-[#6E7191] text-2xl lab-font-size-24"></i>
                        </div>
                        <div>
                            <h3 class="font-medium text-sm capitalize tracking-wide mb-1">{{
                                $t('label.total_sales')
                            ...
                            <h4 class="font-bold text-lg text-[#6E7191]">{{ salesReportOverview?.total_sales }}</h4>
                        </div>
                    </div>
                </div>
                <div class="col-12 sm:col-6 md:col-4 lg:col-6 xl:col-3">
                    ...
                    <tbody class="db-table-body" v-if="salesReports.length > 0">
                        <tr class="db-table-body-tr" v-for="salesReport in salesReports" :key="salesReport">
                            ...
                            <td class="db-table-body-td">
                                {{ currencyFormat(salesReport.total_amount_price || 0, setting.site_digit_after_decimal_point, setting.site_default_currency_symbol, setting.site_currency_position) }}
                            </td>
                            <td class="db-table-body-td">
                                {{ currencyFormat(salesReport.discount_amount_price || 0, setting.site_digit_after_decimal_point, setting.site_default_currency_symbol, setting.site_currency_position) }}
                            </td>
                            <td class="db-table-body-td">
