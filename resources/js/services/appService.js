...
export default {
    ...
    destroyConfirmation: function () {
        ...
        return new VueSimpleAlert.confirm(
            t("message.destroy_confirmation_text"),
            t("message.are_you_sure"),
            "warning",
            {
                confirmButtonText: t("message.destroy_confirm_button"),
                cancelButtonText: t("message.destroy_cancel_button"),
    ...
    acceptOrder: function () {
        const t = i18n.global.t;
        return new VueSimpleAlert.confirm(
            t("message.accept_order_text"),
            t("message.are_you_sure"),
            "warning",
            {
                confirmButtonText: t("message.accept_order_confirm_button"),
                cancelButtonText: t("message.accept_order_cancel_button"),
                confirmButtonColor: "#696cff",
                cancelButtonColor: "#8592a3",
            }
        );
    ...
    cancelOrder: function () {
        const t = i18n.global.t;
        return new VueSimpleAlert.confirm(
            t("message.cancel_order_text"),
            t("message.are_you_sure"),
            "warning",
            {
                confirmButtonText: t("message.cancel_order_confirm_button"),
                cancelButtonText: t("message.cancel_order_cancel_button"),
                confirmButtonColor: "#696cff",
                cancelButtonColor: "#8592a3",
            }
        );
