...
class AppLibrary
{
    ...
    {
        $decimalPoint = env('CURRENCY_DECIMAL_POINT', 0);
        $decimalSeparator = '.';
        $thousandsSeparator = ',';
        ...
        if (env('CURRENCY_POSITION') == CurrencyPosition::LEFT) {
            return env('CURRENCY_SYMBOL') . number_format($amount, $decimalPoint, $decimalSeparator, $thousandsSeparator);
        }
        return number_format($amount, $decimalPoint, $decimalSeparator, $thousandsSeparator) . env('CURRENCY_SYMBOL');
    }
