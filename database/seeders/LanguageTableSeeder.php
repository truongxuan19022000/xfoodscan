...
class LanguageTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        if (file_exists(public_path('/images/language/vietnam.png'))) {
            $vietnameseLanguage->addMedia(public_path('/images/language/vietnam.png'))->preservingOriginal()->toMediaCollection('language');
        }
